...
function Build-Variant {
    ...
    switch ($Agent) {
        ...
        'jules' {
            $cmdDir = Join-Path $baseDir ".jules"
...
$AllAgents = @('claude', 'gemini', 'copilot', 'cursor-agent', 'qwen', 'opencode', 'windsurf', 'codex', 'kilocode', 'auggie', 'roo', 'codebuddy', 'amp', 'q', 'bob', 'qoder', 'jules')
$AllScripts = @('sh', 'ps')
