...
build_variant() {
  ...
  case $agent in
    ...
    jules)
      ...
      generate_commands jules md "\$ARGUMENTS" "$base_dir/.jules" "$script" ;;
  esac
...
ALL_AGENTS=(claude gemini copilot cursor-agent qwen opencode windsurf codex kilocode auggie roo codebuddy amp shai q bob qoder jules)
ALL_SCRIPTS=(sh ps)
